(function () {
    ...
    _proto.verify = function () {
        ...
        if (this.options.remoteUrl !== null) {
            return this.options.verify(JSON.stringify(that.startTime), JSON.stringify(endTime), JSON.stringify(left), JSON.stringify(arr), this.options.remoteUrl + "/verifyCode");
        }
        else {
